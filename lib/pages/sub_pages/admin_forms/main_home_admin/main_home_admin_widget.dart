...
class _MainHomeAdminWidgetState extends State<MainHomeAdminWidget>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController?.text = '10000';
        }));
  }
                                                                        ...
                                                                        children: [
                                                                          FlutterFlowPieChart(
                                                                            data:
                                                                                FFPieChartData(
                                                                              values: [
                                                                                chartActivityRecordList.length,
                                                                          ...
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              entries: [
                                                                                const LegendEntry(Color(0xFF4B39EF), 'Vistas'),
                                                                                LegendEntry(FlutterFlowTheme.of(context).secondary, 'Compras'),
                                                                              ],
                                                                              width: 100.0,
                                                                              height: 50.0,
