...
class OrdersRecord extends FirestoreRecord {
  ...
  // "quanity" field.
  List<CartItemStruct>? _quanity;
  List<CartItemStruct> get quanity => _quanity ?? const [];
  bool hasQuanity() => _quanity != null;

  // "quantity" field.
  List<double>? _quantity;
  List<double> get quantity => _quantity ?? const [];
  ...
  void _initializeFields() {
    ...
    _quanity = getStructList(
      snapshotData['quanity'],
...
class OrdersRecordDocumentEquality implements Equality<OrdersRecord> {
  ...
  bool equals(OrdersRecord? e1, OrdersRecord? e2) {
    ...
    return e1?.name == e2?.name &&
        ...
        listEquality.equals(e1?.quanity, e2?.quanity) &&
