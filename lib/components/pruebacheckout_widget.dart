...
import 'pruebacheckout_model.dart';
export 'pruebacheckout_model.dart';

class PruebacheckoutWidget extends StatefulWidget {
  /// uwu
  const PruebacheckoutWidget({
    super.key,
    this.parameter1,
    this.parameter2,
    this.parameter3,
  ...
  @override
  State<PruebacheckoutWidget> createState() => _PruebacheckoutWidgetState();
}

class _PruebacheckoutWidgetState extends State<PruebacheckoutWidget> {
  late PruebacheckoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PruebacheckoutModel());
    ...
    _model.uuidformTextController ??= TextEditingController();
    _model.uuidformFocusNode ??= FocusNode();
              ...
              child: Container(
                ...
                child: Stack(
                  children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          FFButtonWidget(
                                            onPressed: () async {
                                              safeSetState(() {
                                                _model.teTextController?.text =
                                                    widget.parameter1!
                                                        .toString();
                                              });
                                              safeSetState(() {
                                                _model.uuidformTextController
                                                        ?.text =
                                                    widget.parameter2!
                                                        .toString();
                                              });
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller:
                                                    _model.teTextController,
                                                focusNode: _model.teFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: widget.parameter3
                                                      ?.toString(),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .labelMedium
                                        ...
                                        children: [
                                          Flexible(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .uuidformTextController,
                                                focusNode:
                                                    _model.uuidformFocusNode,
                                                autofocus: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: widget.parameter10
                                                      ?.toString(),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .labelMedium
                                                ...
                                                keyboardType:
                                                    TextInputType.number,
                                                validator: _model
                                                    .uuidformTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ),
                                          ),
                    ...
                    if (widget.parameter13 >= 4)
                      Align(
                        alignment: const AlignmentDirectional(1.0, 0.0),
                        child: wrapWithModel(
                          model: _model.uIMarkerModel,
